...
% TODO: Remove draft watermark (draftwatermark, lmodern, xcolor).
% TODO: Add examples of "soft-skills". (This will be most germane to the PSS
%       section: the composition and delivery of such a course required [some
%       positive trait].)
